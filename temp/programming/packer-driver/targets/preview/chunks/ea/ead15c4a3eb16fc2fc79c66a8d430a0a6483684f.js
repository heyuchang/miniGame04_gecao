  ...
  return {
    ...
    execute: function () {
      ...
      _export("VipLayer", VipLayer = (_dec = ccclass('VipLayer'), _dec(_class = class VipLayer extends (_crd && BaseLayer === void 0 ? (_reportPossibleCrUseOfBaseLayer({
        ...
        initUI() {
          var vip = (_crd && playerModel === void 0 ? (_reportPossibleCrUseOfplayerModel({
            error: Error()
          }), playerModel) : playerModel).vipObj.vip;
          this.setString(this.getNodeByPath("ui/top/rank/val"), vip);
          var infoLayer = this.getNodeByPath("ui/top/bar/info");
          ...
          var btnGet = this.getNodeByPath("ui/top/btnGet");
          ...
          var choseRow = (_crd && designManager === void 0 ? (_reportPossibleCrUseOfdesignManager({
            error: Error()
          }), designManager) : designManager).getRowById((_crd && constants === void 0 ? (_reportPossibleCrUseOfconstants({
            error: Error()
          ...
          var btnGetBox1 = this.getNodeByPath("ui/info/itemLayer/btnBox1/btnGetBox1");
          var hasGet1 = this.getNodeByPath("ui/info/itemLayer/btnBox1/hasGet");
          ...
          var btnGetBox2 = this.getNodeByPath("ui/info/itemLayer/btnBox2/btnGetBox2");
          var hasGet2 = this.getNodeByPath("ui/info/itemLayer/btnBox2/hasGet");
        ...
        onClickBtnGetBox1() {
          ...
          var awardArr = (_crd && UserData === void 0 ? (_reportPossibleCrUseOfUserData({
            error: Error()
        ...
        onClickBtnGet() {
          (_crd && sdkManager === void 0 ? (_reportPossibleCrUseOfsdkManager({
            ...
            if (st == 1) {
              var hasUp = (_crd && playerModel === void 0 ? (_reportPossibleCrUseOfplayerModel({
                error: Error()
...
//# sourceMappingURL=ead15c4a3eb16fc2fc79c66a8d430a0a6483684f.js.map