  ...
  return {
    ...
    execute: function () {
      ...
      _export("PropSystem", PropSystem = (_dec = ccclass('PropSystem'), _dec(_class = class PropSystem extends (_crd && BaseLayer === void 0 ? (_reportPossibleCrUseOfBaseLayer({
        ...
        getPropLayerById(id) {
          var propLayer = this.idPropLayerObj[id];
          ...
          if (!propLayer) {
            ...
            var nodePoolUtil = propLayer.addComponent(_crd && NodePoolUtil === void 0 ? (_reportPossibleCrUseOfNodePoolUtil({
              error: Error()
        ...
        saveDataBefore() {
          (_crd && utilTools === void 0 ? (_reportPossibleCrUseOfutilTools({
            ...
            var nodePoolUtil = propLayer.getComponent(_crd && NodePoolUtil === void 0 ? (_reportPossibleCrUseOfNodePoolUtil({
              error: Error()
            }), NodePoolUtil) : NodePoolUtil);
            nodePoolUtil.forEachUseNode(node => {
              var prop = node.getComponent(_crd && Prop === void 0 ? (_reportPossibleCrUseOfProp({
                error: Error()
              }), Prop) : Prop);
        ...
        addProp(id, worldPos, extraObj) {
          var nodePoolUtil = this.getPropLayerById(id).getComponent(_crd && NodePoolUtil === void 0 ? (_reportPossibleCrUseOfNodePoolUtil({
            error: Error()
          }), NodePoolUtil) : NodePoolUtil);

          var tmpFunc = () => {
            var propNode = nodePoolUtil.getNode();
            var prop = (_crd && cocosUtil === void 0 ? (_reportPossibleCrUseOfcocosUtil({
              error: Error()
        ...
        forAllPropById(propId, cb) {
          var layer = this.getPropLayerById(propId);
          var nodePoolUtil = layer.getComponent(_crd && NodePoolUtil === void 0 ? (_reportPossibleCrUseOfNodePoolUtil({
            error: Error()
          }), NodePoolUtil) : NodePoolUtil);
          nodePoolUtil.forEachUseNode(node => {
            var prop = node.getComponent(_crd && Prop === void 0 ? (_reportPossibleCrUseOfProp({
        ...
        forVisiblePropCollider(cb) {
          (_crd && utilTools === void 0 ? (_reportPossibleCrUseOfutilTools({
            ...
            (_crd && utilTools === void 0 ? (_reportPossibleCrUseOfutilTools({
              ...
              var prop = propNode.getComponent(_crd && Prop === void 0 ? (_reportPossibleCrUseOfProp({
                error: Error()
              }), Prop) : Prop);
        ...
        recyclePropNode(propNode) {
          ...
          var nodePoolUtil = this.getPropLayerById(prop.id).getComponent(_crd && NodePoolUtil === void 0 ? (_reportPossibleCrUseOfNodePoolUtil({
            error: Error()
          }), NodePoolUtil) : NodePoolUtil);
        ...
        updateLogic(dt) {
          // 显示优化
          for (var i in this.idPropLayerObj) {
            var nodePoolUtil = this.getPropLayerById(parseFloat(i)).getComponent(_crd && NodePoolUtil === void 0 ? (_reportPossibleCrUseOfNodePoolUtil({
              error: Error()
            }), NodePoolUtil) : NodePoolUtil);
            nodePoolUtil.forEachUseNode(node => {
              var dis = Vec2.distance(node.getPosition(), (_crd && mapModel === void 0 ? (_reportPossibleCrUseOfmapModel({
                error: Error()
...
//# sourceMappingURL=45954b6fd8eca7fba8fc33965d9577211895033f.js.map