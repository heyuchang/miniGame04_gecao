  ...
  return {
    ...
    execute: function () {
      ...
      _export("SettingLayer", SettingLayer = (_dec = ccclass('SettingLayer'), _dec2 = property({
        ...
        start() {
          var isMusic = (_crd && audioManager === void 0 ? (_reportPossibleCrUseOfaudioManager({
            error: Error()
          }), audioManager) : audioManager).getMusiceVolume();
          var isEffect = (_crd && audioManager === void 0 ? (_reportPossibleCrUseOfaudioManager({
            error: Error()
...
//# sourceMappingURL=3f94b1188cbfb4b28e0a5ff559c3f91be0068126.js.map