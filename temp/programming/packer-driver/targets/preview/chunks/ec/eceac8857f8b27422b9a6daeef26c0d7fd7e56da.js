System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "def02ocTp1NsYQk0XOZV5Fx", "RewardSkinLayer", undefined);
      ...
      _export("RewardSkinLayer", RewardSkinLayer = (_dec = ccclass('RewardSkinLayer'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property({
        type: Prefab
      }), _dec(_class = (_class2 = class RewardSkinLayer extends (_crd && BaseUILayer === void 0 ? (_reportPossibleCrUseOfBaseUILayer({
        error: Error()
        ...
        initList() {
          ...
          var propArr = (_crd && designManager === void 0 ? (_reportPossibleCrUseOfdesignManager({
            ...
            error: Error()
          }), constants) : constants).tableName.prop, 17);

          for (var i = 0; i < propArr.length; i++) {
            var data = propArr[i];

            if (data.p1 == 2) {
              var item = instantiate(this.itemProp);
              item.active = true;
              ...
              propItem.getComponent(_crd && PropItemPrefab === void 0 ? (_reportPossibleCrUseOfPropItemPrefab({
                error: Error()
              }), PropItemPrefab) : PropItemPrefab).setView(data.id, 0, (_crd && PropItemPrefab === void 0 ? (_reportPossibleCrUseOfPropItemPrefab({
                error: Error()
              ...
              if ((_crd && UserData === void 0 ? (_reportPossibleCrUseOfUserData({
                error: Error()
              }), UserData) : UserData).getInstance().isHaveProp(data.id)) {
        ...
        onClickVideoGet(event, data) {
          ...
          (_crd && sdkManager === void 0 ? (_reportPossibleCrUseOfsdkManager({
            error: Error()
          }), sdkManager) : sdkManager).openAd("获取皮肤", function (st) {
            if (st == 1) {
              var propItem = {
                Id: data,
                Num: 1
...
//# sourceMappingURL=eceac8857f8b27422b9a6daeef26c0d7fd7e56da.js.map