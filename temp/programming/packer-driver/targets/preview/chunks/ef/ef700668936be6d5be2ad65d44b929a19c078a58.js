    ...
    execute: function () {
      ...
      LayerManager = class LayerManager {
        ...
        createNotice(content) {
          // 显示一条提示信息
          var noticeLayer = find((_crd && constants === void 0 ? (_reportPossibleCrUseOfconstants({
            error: Error()
        ...
        addLayerNameId(name, id) {
          var arr = this.layerNameIdArrMap.get(name);
        ...
        openSingleLayer(layerName, obj, cb, openSuccessCb) {
          ...
          var idArr = this.layerNameIdArrMap.get(layerName);
          ...
          var id = idArr[0];
          var layer = this.openedLayerMap.get(id);
          ...
          var layerParams = this.openingLayerMap.get(id);
        ...
        openLayer(layerName, obj, cb, openSuccessCb) {
          ...
          (_crd && resManager === void 0 ? (_reportPossibleCrUseOfresManager({
            ...
            var com = node.getComponent(layerName) || node.addComponent(layerName); // 加载每个layer特定需要的资源
        ...
        closeLayer(layerId) {
          if (typeof layerId == "string") {
            var idArr = this.layerNameIdArrMap.get(layerId);
          ...
          var layer = this.openedLayerMap.get(layerId);
          ...
          var layerParams = this.openingLayerMap.get(layerId);
...
//# sourceMappingURL=ef700668936be6d5be2ad65d44b929a19c078a58.js.map