  ...
  return {
    ...
    execute: function () {
      ...
      _export("Monster6", Monster6 = (_dec = ccclass('Monster6'), _dec(_class = class Monster6 extends Component {
        ...
        getDirection() {
          var pos = this.monster.node.getPosition();
        ...
        useSkill4() {
          ...
          this.schedule(() => {
            this.numCount++;
            var pos = this.monster.getInfoPosition(3, true);
        ...
        useSkill3() {
          ...
          var pos = this.monster.getInfoPosition(2, true);
          (_crd && mapModel === void 0 ? (_reportPossibleCrUseOfmapModel({
            error: Error()
...
//# sourceMappingURL=3a588704bb89df5ee524abd0fba1aa0562feddba.js.map