    ...
    execute: function () {
      ...
      _export("MainLayer", MainLayer = (_dec = ccclass('MainLayer'), _dec2 = property({
        ...
        onLoad() {
          ...
          var btnPyramid = this.getNodeByPath("btnsLeft/btnPyramid");
          ...
          var btnDayTask = this.getNodeByPath("btnsLeft/btnDayTask");
          ...
          var btnGuess = this.getNodeByPath("btnsLeft/btnGuess");
        ...
        onClickBtnDuihuan() {
          ...
          var tishi = this.duihuanBg.getChildByName("tishilabel");
          tishi.active = false;
        }
        ...
        onClickBtnTuihuan() {
          var tishi = this.duihuanBg.getChildByName("tishilabel");
          tishi.active = false;
          var str = this.shurukuang.getComponent(EditBox).string;
        ...
        start() {
          var btnset = this.getNodeByPath("btnSet");
          var btnEmail = this.getNodeByPath("btnLetter");
          var TopUILayer = this.node.parent.parent.getChildByName("TopUILayer");
          ...
          if (screen1.width / screen1.height >= 720 / 1440) {
            var btnGo = this.getNodeByPath("btnGo");
            btnGo.position = new Vec3(btnGo.position.x, -360, btnGo.position.z);

            var _Map = this.getNodeByPath("Map");

            _Map.position = new Vec3(_Map.position.x, 30, _Map.position.z);
          }
          ...
          if ((_crd && UserData === void 0 ? (_reportPossibleCrUseOfUserData({
            ...
            var role = this.getNodeByPath("Map/role");
            role.active = false;
          ...
          var arr = [];
          var propArr = (_crd && designManager === void 0 ? (_reportPossibleCrUseOfdesignManager({
            error: Error()
        ...
        initMapLevel(level, isaction) {
          ...
          var iconIndex = (mapData[level - 1].id - 1) % 2 + 1;
...
//# sourceMappingURL=6e132d534ebc3ce7f23c9b7931cb6fc896485879.js.map