  ...
  return {
    ...
    execute: function () {
      ...
      _export("DaySignLayer", DaySignLayer = (_dec = ccclass('DaySignLayer'), _dec(_class = class DaySignLayer extends (_crd && BaseLayer === void 0 ? (_reportPossibleCrUseOfBaseLayer({
        ...
        onLoad() {
          super.onLoad();
          var itemLayer = this.getNodeByPath("ui/itemLayer");
          var propItem = find("propItem", itemLayer);
          ...
          var itemLayer2 = (_crd && cocosUtil === void 0 ? (_reportPossibleCrUseOfcocosUtil({
            error: Error()
          }), cocosUtil) : cocosUtil).instantiate(itemLayer);
          itemLayer2.parent = itemLayer.parent;
          var pos = itemLayer2.getPosition();
          pos.y -= 150;
        ...
        initUI() {
          var now = new Date();
          var day = Math.floor((now.getTime() - (_crd && playerModel === void 0 ? (_reportPossibleCrUseOfplayerModel({
            error: Error()
          ...
          for (var i = 0; i < this.itemUIArr.length; i++) {
            ...
            var getNode = find("get", itemUI);
            var patchNode = find("patch", itemUI);
            var targetNode = find("target", itemUI);
        ...
        refreshFinalAwardLayer() {
          var getNode = this.getNodeByPath("ui/bottom/extraAward/get");
          var lockNode = this.getNodeByPath("ui/bottom/extraAward/lock");
          getNode.active = false;
...
//# sourceMappingURL=b83374cff86ce6875b533bb0403c39abcfc9a64b.js.map