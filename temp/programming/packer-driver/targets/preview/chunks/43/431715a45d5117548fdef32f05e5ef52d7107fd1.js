      ...
      _export("bullet9", bullet9 = (_dec = ccclass('bullet9'), _dec(_class = class bullet9 extends Component {
        ...
        init(bullet) {
          ...
          this.scheduleOnce(() => {
            ...
            var dis = Vec2.distance(playerPos, this.bullet.node.getPosition());
            ...
            tween(this.bullet.node).to(time, {
              ...
              var p = this.bullet.node.getPosition();
...
//# sourceMappingURL=431715a45d5117548fdef32f05e5ef52d7107fd1.js.map