  ...
  return {
    ...
    execute: function () {
      ...
      _export("PropItemPrefab", PropItemPrefab = (_dec = ccclass('PropItemPrefab'), _dec2 = property({
        ...
        setScale(width) {
          var bgWidth = this.bg.getComponent(UITransform).width;
          var bgHeight = this.bg.getComponent(UITransform).height;
...
//# sourceMappingURL=525546eeb8a59007bb84576223e4a73c7cf7c843.js.map