    ...
    execute: function () {
      ...
      _export("GuessGameLayer", GuessGameLayer = (_dec = ccclass('GuessGameLayer'), _dec2 = property({
        ...
        start() {
          ...
          var stone1 = (_crd && designManager === void 0 ? (_reportPossibleCrUseOfdesignManager({
            error: Error()
        ...
        initGuess() {
          ...
          var selectGuess = this.selectGuessNode.getChildByName("selectGuess");
        ...
        onSelectBet(event, data) {
          ...
          var selectItem = instantiate(this.items[this._curSelectBet]);
        ...
        onSelectBtn(event, data) {
          ...
          var curBet = (_crd && designManager === void 0 ? (_reportPossibleCrUseOfdesignManager({
            error: Error()
        ...
        openResult() {
          ...
          var stoneDraw = (_crd && designManager === void 0 ? (_reportPossibleCrUseOfdesignManager({
            error: Error()
...
//# sourceMappingURL=5583b50ce2d045f6df7d1c6f47118ee533a18dd3.js.map