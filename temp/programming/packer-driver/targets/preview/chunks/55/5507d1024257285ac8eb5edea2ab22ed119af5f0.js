    ...
    execute: function () {
      ...
      _export("Weapon", Weapon = (_dec = ccclass('Weapon'), _dec(_class = class Weapon extends (_crd && BaseLayer === void 0 ? (_reportPossibleCrUseOfBaseLayer({
        ...
        init(info) {
          ...
          try {
            var weaponUtil = (_crd && cocosUtil === void 0 ? (_reportPossibleCrUseOfcocosUtil({
              error: Error()
          ...
          if (this.weaponUtil && this.weaponUtil.weaponId > 0 && (_crd && mapModel === void 0 ? (_reportPossibleCrUseOfmapModel({
            ...
            this.atkPercentAdd = _row.atk / 100;
          }
          ...
          if ((_crd && mapModel === void 0 ? (_reportPossibleCrUseOfmapModel({
            ...
            // 主武器攻击力收到vip等级加成
            var vipRow = (_crd && designManager === void 0 ? (_reportPossibleCrUseOfdesignManager({
              error: Error()
            }), designManager) : designManager).getRowById((_crd && constants === void 0 ? (_reportPossibleCrUseOfconstants({
              error: Error()
        ...
        atkByDart() {
          ...
          var p = (_crd && cocosUtil === void 0 ? (_reportPossibleCrUseOfcocosUtil({
            error: Error()
        ...
        atkByShot() {
          ...
          this.canFace = false;
          var back = this.direction.clone().normalize().negative().multiplyScalar(20);
          var orignPos = this.node.getPosition();
          var time = 0.05;
        ...
        atkByFist(atkDis, time) {
          ...
          var back = this.direction.clone().normalize().negative().multiplyScalar(20);
          var target = this.direction.clone().normalize().multiplyScalar(atkDis);
        ...
        targetForceMoveBack(node) {
          ...
          var monster = node.getComponent(_crd && Monster === void 0 ? (_reportPossibleCrUseOfMonster({
            error: Error()
          }), Monster) : Monster);
          ...
          var direction = this.direction.clone().normalize().multiplyScalar(50);
          tween(node).by(0.02, {
            position: direction
          }).start();
        }
        ...
        getInfoPosition(index, isWorld) {
          var pos = this.node.getPosition();
          var infoNode = find("info", this.node);
          ...
          if (infoNode) {
            ...
            var infoPos = infoNode.getPosition();
        ...
        contactBegin(selfCollider, otherCollider) {
          if (otherCollider.group == (_crd && physicsGroup === void 0 ? (_reportPossibleCrUseOfphysicsGroup({
            ...
            var monster = otherCollider.getComponent(_crd && Monster === void 0 ? (_reportPossibleCrUseOfMonster({
              error: Error()
            }), Monster) : Monster);
        ...
        getDisTargetNode() {
          ...
          var dis = Vec2.distance(this.getCalPosition(), this.targetNode.position);
          return dis;
        }
        ...
        updateLogic(dt) {
          ...
          var targetNode = (_crd && mapModel === void 0 ? (_reportPossibleCrUseOfmapModel({
            error: Error()
          ...
          var pos1 = (_crd && cocosUtil === void 0 ? (_reportPossibleCrUseOfcocosUtil({
            error: Error()
          }), cocosUtil) : cocosUtil).convertToWorldSpace(this.node);
          var pos2 = (_crd && cocosUtil === void 0 ? (_reportPossibleCrUseOfcocosUtil({
            error: Error()
...
//# sourceMappingURL=5507d1024257285ac8eb5edea2ab22ed119af5f0.js.map