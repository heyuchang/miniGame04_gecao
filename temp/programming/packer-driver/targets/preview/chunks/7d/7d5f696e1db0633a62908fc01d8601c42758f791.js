    ...
    execute: function () {
      ...
      _export("PatrolFastLayer", PatrolFastLayer = (_dec = ccclass('PatrolFastLayer'), _dec2 = property({
        ...
        start() {
          ...
          for (var index = 0; index < rewardArr.length && index < 2; index++) {
            var element = rewardArr[index];

            var _item = instantiate(this.propIten);
            ...
            this.addPropLayer.addChild(_item);
          }
...
//# sourceMappingURL=7d5f696e1db0633a62908fc01d8601c42758f791.js.map