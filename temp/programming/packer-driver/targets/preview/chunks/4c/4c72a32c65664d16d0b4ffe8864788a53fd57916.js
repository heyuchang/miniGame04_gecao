    ...
    execute: function () {
      ...
      _export("SkillSelectLayer", SkillSelectLayer = (_dec = ccclass('SkillSelectLayer'), _dec(_class = class SkillSelectLayer extends (_crd && BaseLayer === void 0 ? (_reportPossibleCrUseOfBaseLayer({
        ...
        refreshInfoLayer() {
          ...
          return;
          var lvCount = this.layerData.lvCount;
          ...
          if ((_crd && mapModel === void 0 ? (_reportPossibleCrUseOfmapModel({
            ...
            var refreshInfoNode = this.getNodeByPath("ui/btns/btnRefresh/info");
            var refreshFreeNode = this.getNodeByPath("ui/btns/btnRefresh/free");
        ...
        refreshSelectItem(itemUI, item) {
          ...
          var btnDoubleSelect = find("btnDoubleSelect", itemUI);
          btnDoubleSelect.active = false;
          var selectEffect = find("selectEffect", itemUI);
          ...
          var bgNode = find("bg", itemUI);
          var bg2Node = find("bg2", itemUI);
          ...
          if (item.name == (_crd && constants === void 0 ? (_reportPossibleCrUseOfconstants({
            ...
            this.setNumItemLayer(starLayer, (_crd && constants === void 0 ? (_reportPossibleCrUseOfconstants({
              ...
              var uiOpacity = starItemUI.getComponent(UIOpacity);
              uiOpacity.opacity = 255;
              Tween.stopAllByTarget(uiOpacity);
              var starIcon = find("icon", starItemUI);
              var starIcon2 = find("icon2", starItemUI);
              var yinIcon = find("yin", starItemUI);
          ...
          var combLayer = find("comb", itemUI);

          if (row.skillArr) {
            combLayer.active = true;
            var iconNode = find("icon", combLayer);
            var skillId = 0;
            (_crd && utilTools === void 0 ? (_reportPossibleCrUseOfutilTools({
              error: Error()
            }), utilTools) : utilTools).forArr(row.skillArr, type => {
              var sInfo = (_crd && mapModel === void 0 ? (_reportPossibleCrUseOfmapModel({
                error: Error()
            ...
            var skillRow = (_crd && designManager === void 0 ? (_reportPossibleCrUseOfdesignManager({
              error: Error()
            }), designManager) : designManager).getRowById((_crd && constants === void 0 ? (_reportPossibleCrUseOfconstants({
              error: Error()
        ...
        doSelectItem(node, isYin, callback, isDouble) {
          if (isYin === void 0) {
            isYin = true;
          }
          ...
          (_crd && utilTools === void 0 ? (_reportPossibleCrUseOfutilTools({
            ...
            if (starNode && starNode.activeInHierarchy) {
              // 星星选中特效
              var selectEffect = find("selectEffect", node);
              ...
              if (isDouble) {
                // 连升两星
                var starNode2 = find("starLayer", node).children[row.lv];

                if (starNode2) {
                  var selectEffect2 = (_crd && cocosUtil === void 0 ? (_reportPossibleCrUseOfcocosUtil({
                    error: Error()
        ...
        onClickBtnDoubleSelect(node) {
          ...
          (_crd && sdkManager === void 0 ? (_reportPossibleCrUseOfsdkManager({
            ...
            if (st == 1) {
              this.hasSelect = true;
              var starNode = node.parent.starNode;
...
//# sourceMappingURL=4c72a32c65664d16d0b4ffe8864788a53fd57916.js.map