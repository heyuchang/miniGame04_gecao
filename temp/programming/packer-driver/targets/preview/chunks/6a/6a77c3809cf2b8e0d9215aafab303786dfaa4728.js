    ...
    execute: function () {
      ...
      _export("MapLayer", MapLayer = (_dec = ccclass('MapLayer'), _dec(_class = class MapLayer extends (_crd && BaseLayer === void 0 ? (_reportPossibleCrUseOfBaseLayer({
        ...
        onLoad() {
          ...
          var mapLayer = find("map", (_crd && mapModel === void 0 ? (_reportPossibleCrUseOfmapModel({
            error: Error()
          ...
          var monsterSystem = find("monsterLayer", mapLayer).addComponent(_crd && MonsterSystem === void 0 ? (_reportPossibleCrUseOfMonsterSystem({
            error: Error()
          }), MonsterSystem) : MonsterSystem);
          var bulletSystem = find("bulletLayer", mapLayer).addComponent(_crd && BulletSystem === void 0 ? (_reportPossibleCrUseOfBulletSystem({
            error: Error()
          }), BulletSystem) : BulletSystem);
          var numSystem = find("numLayer", mapLayer).addComponent(_crd && NumSystem === void 0 ? (_reportPossibleCrUseOfNumSystem({
            error: Error()
          }), NumSystem) : NumSystem);
          var skillSystem = find("player/skillLayer", mapLayer).addComponent(_crd && SkillSystem === void 0 ? (_reportPossibleCrUseOfSkillSystem({
            error: Error()
          }), SkillSystem) : SkillSystem);
          var weaponSystem = find("player/weaponLayer", mapLayer).addComponent(_crd && WeaponSystem === void 0 ? (_reportPossibleCrUseOfWeaponSystem({
            error: Error()
          }), WeaponSystem) : WeaponSystem);
          var hintSystem = find("hintLayer", mapLayer).addComponent(_crd && HintSystem === void 0 ? (_reportPossibleCrUseOfHintSystem({
            error: Error()
          }), HintSystem) : HintSystem);
          var propSystem = find("propLayer", mapLayer).addComponent(_crd && PropSystem === void 0 ? (_reportPossibleCrUseOfPropSystem({
            error: Error()
          ...
          var mapData = (_crd && UserData === void 0 ? (_reportPossibleCrUseOfUserData({
            error: Error()
        ...
        refreshBossHpLayer() {
          var bossMonster = (_crd && mapModel === void 0 ? (_reportPossibleCrUseOfmapModel({
            error: Error()
        ...
        bossSubHp(dam) {
          var pStart = this.bossHpProgress.getComponent(ProgressBar).progress;
          this.bossDamProgressBar.progress = pStart;
          (_crd && mapModel === void 0 ? (_reportPossibleCrUseOfmapModel({
            error: Error()
          }), mapModel) : mapModel).mapLayer.refreshBossHpLayer();
          var pEnd = this.bossHpProgress.getComponent(ProgressBar).progress;
          Tween.stopAllByTarget(this.bossDamProgressBar);
        ...
        refreshExpLayer() {
          ...
          var total = row.exp;
          var current = (_crd && mapModel === void 0 ? (_reportPossibleCrUseOfmapModel({
            error: Error()
        ...
        refreshTimeNode() {
          var timeStr = (_crd && utilTools === void 0 ? (_reportPossibleCrUseOfutilTools({
            error: Error()
...
//# sourceMappingURL=6a77c3809cf2b8e0d9215aafab303786dfaa4728.js.map