  ...
  return {
    ...
    execute: function () {
      ...
      wechat = class wechat {
        ...
        preLoadBanner() {
          for (var i = 0; i < this._bannerAdUnitId.length; i++) {
            var id = this._bannerAdUnitId[i];
            var bannerAd = this.createBanner(id);
        ...
        createBanner(id) {
          ...
          var bannerObj = wx.createBannerAd({
            // 广告单元 id
            adUnitId: id,
        ...
        createUserInfoButton(x, y, width, height) {
          if (x === void 0) {
            x = 0;
          }
        ...
        showBannerNext() {
          ...
          var bannerAd = this._bannerAdObjList[this._bannerShowIndex];

          if (bannerAd) {
            bannerAd.show().catch(() => {
              var id = this._bannerAdUnitId[this._bannerShowIndex];
        ...
        */
        ...
        createBannerAd(refreshTime, next, isShow) {
          if (isShow === void 0) {
            isShow = true;
          }
          ...
          var id = this._bannerAdUnitId[Math.floor(Math.random() * this._bannerAdUnitId.length)];
        ...
        showRewardVideoAd(successShowCb) {
          return new Promise((resolve, reject) => {
            ...
            var closeListener = res => {
              var isComplete; // 小于 2.1.0 的基础库版本，res 是一个 undefined
        ...
        createRewardedVideoAd() {
          ...
          var id = Math.floor(Math.random() * this._rewardedVideoAdUnitId.length);
        ...
        reportShareBehavior(data) {
          ...
          var result = this.rewardedVideoAd.reportShareBehavior(data);
        ...
        createInterstitialAd() {
          if (!this.interstitialAd) {
            var id = this._interstitialAdUnitId[Math.floor(Math.random() * this._interstitialAdUnitId.length)];
         ...
         */
        showToast(title, duration, callback) {
          if (duration === void 0) {
            duration = 3000;
          }
        ...
        createIconAd() {
          var styleItemArray = [...Array(global.iconCount + 1).map((_, i) => ({
            appNameHidden: false,
            color: 'white',
            size: 100,
            borderWidth: 100,
...
//# sourceMappingURL=5f98b0fa162dd0e695c1315fe681fedf65f6dae0.js.map