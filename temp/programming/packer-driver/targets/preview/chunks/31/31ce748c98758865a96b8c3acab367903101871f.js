    ...
    execute: function () {
      ...
      _export("LoadingLayer", LoadingLayer = (_dec = ccclass('LoadingLayer'), _dec(_class = class LoadingLayer extends (_crd && BaseLayer === void 0 ? (_reportPossibleCrUseOfBaseLayer({
        ...
        onLoad() {
          ...
          var pos = this.flagNode.getPosition();
          pos.x = this.startGap;
          ...
          var chs = this.getNodeByPath("ui/logo").children;
        ...
        releaseAllSpriteFrame() {
          for (var i = 0; i < this.spriteFrameArr.length; i++) {
            var spriteFrame = this.spriteFrameArr[i];
            spriteFrame.decRef();
          }
        ...
        update(dt) {
          ...
          var progress = this.designResProgress * this.designResPercent + this.bundleArrProgress * this.bundleArrPercent + this.layerProgress * this.layerPercent; // 防止计算过后，是0.999999的情况    
...
//# sourceMappingURL=31ce748c98758865a96b8c3acab367903101871f.js.map