  ...
  return {
    ...
    execute: function () {
      ...
      _export("AnimationTrack", AnimationTrack = (_dec = ccclass('AnimationTrack'), _dec(_class = class AnimationTrack extends Component {
        ...
        moveTargetUpdate(dt) {
          var targetPos = (_crd && cocosUtil === void 0 ? (_reportPossibleCrUseOfcocosUtil({
            error: Error()
          ...
          var direction = targetPos.subtract(nodePos).normalize();
          var dis = dt * 1500;
...
//# sourceMappingURL=69a0a32e620bf30703d30cf461af7ff32a651e02.js.map