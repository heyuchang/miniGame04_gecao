    ...
    execute: function () {
      ...
      _export("ChapterLayer", ChapterLayer = (_dec = ccclass('ChapterLayer'), _dec2 = property({
        ...
        setPage(index) {
          ...
          for (var _i = 0; _i < this._curRewardList.length; _i++) {
            var _element = this._curRewardList[_i]; //  let dataArr = this.stringToArr(element)

            var item = instantiate(this.rewardItem);
            ...
            item.getComponent(_crd && PropItemPrefab === void 0 ? (_reportPossibleCrUseOfPropItemPrefab({
              error: Error()
            }), PropItemPrefab) : PropItemPrefab).setView(_element[0], _element[1]);
          }
        }
        ...
        onGetReward() {
          ...
          var curRewardArr = (_crd && UserData === void 0 ? (_reportPossibleCrUseOfUserData({
            error: Error()
...
//# sourceMappingURL=7eafb0d5fa5ebad2befbe5e2d0607c80f3a9b976.js.map