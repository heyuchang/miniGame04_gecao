    ...
    execute: function () {
      ...
      _export("bullet1071", bullet1071 = (_dec = ccclass('bullet1071'), _dec(_class = class bullet1071 extends Component {
        ...
        init(bullet) {
          this.bullet = bullet;
          this.node.angle = 0;
          var lv = this.bullet.extraObj.lv;
          this.lv = lv;
          var frameColor = "#22D600".parseColor();
          ...
          var uiOpacity = this.bullet.bodyNode.getComponent(UIOpacity);
          uiOpacity.opacity = 0;
          ...
          var frameLayer = find("frameLayer", this.node);
          var time = 0.8;
...
//# sourceMappingURL=4b3e0b3f30c97f2b0dc86c0950e9b13ec9217804.js.map