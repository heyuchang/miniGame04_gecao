    ...
    execute: function () {
      ...
      _export("ShopLayer", ShopLayer = (_dec = ccclass('ShopLayer'), _dec2 = property({
        ...
        onEnable() {
          ...
          var arr = [10082, 10113, 10010];
          var arr1 = [10066, 10155, 10118];

          for (var i = 0; i < arr.length; i++) {
            var propItem = instantiate(self.propItem);
          ...
          for (var _i = 0; _i < arr1.length; _i++) {
            var _propItem = instantiate(self.propItem);

            this.layer2.addChild(_propItem);
            _propItem.position = v3(0, 0, 0);

            _propItem.getComponent(_crd && PropItemPrefab === void 0 ? (_reportPossibleCrUseOfPropItemPrefab({
              error: Error()
            }), PropItemPrefab) : PropItemPrefab).setView(arr1[_i], 1, (_crd && PropItemPrefab === void 0 ? (_reportPossibleCrUseOfPropItemPrefab({
              error: Error()
            }), PropItemPrefab) : PropItemPrefab).Type_UnTouch | (_crd && PropItemPrefab === void 0 ? (_reportPossibleCrUseOfPropItemPrefab({
              error: Error()
            }), PropItemPrefab) : PropItemPrefab).Type_HideNum);
        ...
        onOnceCard() {
          ...
          if (isEnougth) {
            ...
            this.gaojiProp = [];
            this._rewardArr = [];
            var item = (_crd && UserData === void 0 ? (_reportPossibleCrUseOfUserData({
              error: Error()
        ...
        checkShowGaoji() {
          if (this.gaojiProp.length > 0) {
            var propData = this.gaojiProp.shift();
...
//# sourceMappingURL=60ad90816e3496d101cfd9115e5e4b67ec43e6db.js.map