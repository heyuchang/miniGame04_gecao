    ...
    execute: function () {
      ...
      _export("Skill3", Skill3 = (_dec = ccclass('Skill3'), _dec(_class = class Skill3 extends Component {
        ...
        updateLogic(dt) {
          ...
          this.timeCount = 0;
          this.num++;
          var direction = targetNode.getPosition().subtract((_crd && mapModel === void 0 ? (_reportPossibleCrUseOfmapModel({
            error: Error()
...
//# sourceMappingURL=e47408d143c0a2e2337f5263dc8eb4989045c03e.js.map