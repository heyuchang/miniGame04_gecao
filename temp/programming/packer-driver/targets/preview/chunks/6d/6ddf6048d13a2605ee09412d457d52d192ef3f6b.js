    ...
    execute: function () {
      ...
      _export("GameLaunch", GameLaunch = (_dec = ccclass('GameLaunch'), _dec(_class = class GameLaunch extends (_crd && BaseLayer === void 0 ? (_reportPossibleCrUseOfBaseLayer({
        ...
        onLoad() {
          ...
          var noticeName = (_crd && constants === void 0 ? (_reportPossibleCrUseOfconstants({
            error: Error()
        ...
        onMessageEvent(value) {
          ...
          var ctr = (_crd && ServerCtr === void 0 ? (_reportPossibleCrUseOfServerCtr({
            error: Error()
          ...
          switch (value.cmd) {
            case (_crd && GNetCmd === void 0 ? (_reportPossibleCrUseOfGNetCmd({
              ...
              var friendData = JSON.parse(value.friendData);
              (_crd && playerModel === void 0 ? (_reportPossibleCrUseOfplayerModel({
                error: Error()
...
//# sourceMappingURL=6ddf6048d13a2605ee09412d457d52d192ef3f6b.js.map