  ...
  return {
    ...
    execute: function () {
      ...
      _export("bullet1021", bullet1021 = (_dec = ccclass('bullet1021'), _dec(_class = class bullet1021 extends Component {
        ...
        init(bullet) {
          this.bullet = bullet;
          var direction = this.bullet.extraObj.direction;
        ...
        getScale() {
          var scale = 1 + (_crd && mapModel === void 0 ? (_reportPossibleCrUseOfmapModel({
            error: Error()
...
//# sourceMappingURL=9d12796fdf774472b6b07bd9d3b664f5582498ef.js.map