  ...
  return {
    ...
    execute: function () {
      ...
      _export("TowerRoleLayer", TowerRoleLayer = (_dec = ccclass('TowerRoleLayer'), _dec(_class = class TowerRoleLayer extends (_crd && BaseLayer === void 0 ? (_reportPossibleCrUseOfBaseLayer({
        ...
        initUI() {
          let idArr = (_crd && UserData === void 0 ? (_reportPossibleCrUseOfUserData({
            error: Error()
        ...
        onClickBtnOpt() {
          let ret = (_crd && UserData === void 0 ? (_reportPossibleCrUseOfUserData({
            error: Error()
...
//# sourceMappingURL=4f2863727b93d9ee8561d07a5476a516536b5e7e.js.map