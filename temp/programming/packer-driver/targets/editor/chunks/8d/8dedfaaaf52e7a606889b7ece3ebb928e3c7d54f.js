      ...
      _export("DayTaskLayer", DayTaskLayer = (_dec = ccclass('DayTaskLayer'), _dec(_class = class DayTaskLayer extends (_crd && BaseLayer === void 0 ? (_reportPossibleCrUseOfBaseLayer({
        ...
        initUI() {
          ...
          (_crd && utilTools === void 0 ? (_reportPossibleCrUseOfutilTools({
            ...
            let info1 = (_crd && playerModel === void 0 ? (_reportPossibleCrUseOfplayerModel({
              error: Error()
            }), playerModel) : playerModel).getTaskInfoById(task1.id);
            let info2 = (_crd && playerModel === void 0 ? (_reportPossibleCrUseOfplayerModel({
              error: Error()
        ...
        refreshTopLayer() {
          let actNum = (_crd && UserData === void 0 ? (_reportPossibleCrUseOfUserData({
            error: Error()
        ...
        onClickBoxItem(node) {
          ...
          for (let i = 0; i < this.flagArr.length; i++) {
            let flag = this.getAwardFlag(i);
            let award = (_crd && designManager === void 0 ? (_reportPossibleCrUseOfdesignManager({
              error: Error()
...
//# sourceMappingURL=8dedfaaaf52e7a606889b7ece3ebb928e3c7d54f.js.map