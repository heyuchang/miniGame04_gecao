  ...
  return {
    ...
    execute: function () {
      ...
      MapModel = class MapModel {
        ...
        enterMapWithMapId(mapId, floor = 0) {
          let obj = {};
          obj.mapId = mapId;
          obj.floor = floor;
          ...
          if (row.type == (_crd && constants === void 0 ? (_reportPossibleCrUseOfconstants({
            ...
            if ((_crd && UserData === void 0 ? (_reportPossibleCrUseOfUserData({
              ...
              let curDrop = (_crd && designManager === void 0 ? (_reportPossibleCrUseOfdesignManager({
                error: Error()
              }), designManager) : designManager).getRowById((_crd && constants === void 0 ? (_reportPossibleCrUseOfconstants({
                error: Error()
            ...
            let info = (_crd && UserData === void 0 ? (_reportPossibleCrUseOfUserData({
              error: Error()
            }), UserData) : UserData).getInstance().getTowerRoleProInfo(true);
            obj.hp = info.hp;
            obj.atk = info.atk;
            let propRow = (_crd && designManager === void 0 ? (_reportPossibleCrUseOfdesignManager({
              error: Error()
            }), designManager) : designManager).getRowById((_crd && constants === void 0 ? (_reportPossibleCrUseOfconstants({
              error: Error()
            }), constants) : constants).tableName.prop, (_crd && UserData === void 0 ? (_reportPossibleCrUseOfUserData({
        ...
        isInScreenVisible(node) {
          ...
          let playerPos = (_crd && cocosUtil === void 0 ? (_reportPossibleCrUseOfcocosUtil({
            error: Error()
        ...
        loadOtherRes(progressCb, endCb) {
          ...
          let pathArr = ["map/" + mapRow.bg, "wall/" + mapRow.wall + "_v", "wall/" + mapRow.wall + "_h"];
          (_crd && resManager === void 0 ? (_reportPossibleCrUseOfresManager({
            error: Error()
...
//# sourceMappingURL=1c29642b76ec2c6ad5e486c8df0ff099024e7c3e.js.map