    ...
    execute: function () {
      ...
      _export("BaseLayer", BaseLayer = class BaseLayer extends Component {
        ...
        screenAdapterBG(node) {
          ...
          let scale = (_crd && cocosUtil === void 0 ? (_reportPossibleCrUseOfcocosUtil({
            error: Error()
        ...
        openPropInfoLayer2(id, num = undefined) {
          if (num == undefined) {
        ...
        setRoleSkin(roleNode, id = 0) {
          let skin = (_crd && UserData === void 0 ? (_reportPossibleCrUseOfUserData({
            error: Error()
        ...
        showLackItem(itemId) {
          let itemRow = (_crd && designManager === void 0 ? (_reportPossibleCrUseOfdesignManager({
            error: Error()
        ...
        scrollViewSetData(scrollViewNode, arr, refreshItemFunc, resetPos = true, itemTween = false) {
          let scrollViewUtil = scrollViewNode.getComponent(_crd && ScrollViewUtil === void 0 ? (_reportPossibleCrUseOfScrollViewUtil({
            error: Error()
          }), ScrollViewUtil) : ScrollViewUtil);
        ...
        scrollViewAddData(scrollViewNode, arr, resetPos = false) {
          let scrollViewUtil = scrollViewNode.getComponent(_crd && ScrollViewUtil === void 0 ? (_reportPossibleCrUseOfScrollViewUtil({
            error: Error()
          }), ScrollViewUtil) : ScrollViewUtil);
        ...
        scrollViewRemoveItemUI(scrollViewNode, itemUI, resetPos = false) {
          let scrollViewUtil = scrollViewNode.getComponent(_crd && ScrollViewUtil === void 0 ? (_reportPossibleCrUseOfScrollViewUtil({
            error: Error()
          }), ScrollViewUtil) : ScrollViewUtil);
        ...
        scrollViewRemoveItemUIByIndex(scrollViewNode, index, resetPos = false) {
          let scrollViewUtil = scrollViewNode.getComponent(_crd && ScrollViewUtil === void 0 ? (_reportPossibleCrUseOfScrollViewUtil({
            error: Error()
          }), ScrollViewUtil) : ScrollViewUtil);
        ...
        setItemLayer(node, arr, cb) {
          let itemLayer = (_crd && cocosUtil === void 0 ? (_reportPossibleCrUseOfcocosUtil({
            error: Error()
        ...
        setNumItemLayer(node, num, cb) {
          ...
          let itemLayer = node.getComponent(_crd && ItemLayer === void 0 ? (_reportPossibleCrUseOfItemLayer({
            error: Error()
          }), ItemLayer) : ItemLayer);
        ...
        setPropItem(id, iconNode, num = 0, bgNode, numNode) {
          ...
          if (row.type == 11) {
            let wRow = (_crd && designManager === void 0 ? (_reportPossibleCrUseOfdesignManager({
              error: Error()
            }), designManager) : designManager).getRowById((_crd && constants === void 0 ? (_reportPossibleCrUseOfconstants({
              error: Error()
        ...
        removeRenderBatch(node) {
          let itemLayer = node.parent.getComponent(_crd && ItemLayer === void 0 ? (_reportPossibleCrUseOfItemLayer({
            error: Error()
          }), ItemLayer) : ItemLayer);
        ...
        setSpriteFrame(node, name, showCb, bundleName1 = (_crd && constants === void 0 ? (_reportPossibleCrUseOfconstants({
          error: Error()
        ...
        setSpriteFrame2(node, name, showCb, bundleName1 = (_crd && constants === void 0 ? (_reportPossibleCrUseOfconstants({
          error: Error()
        }), constants) : constants).bundles.icon) {
          if (!name) {
            return;
...
//# sourceMappingURL=56fcb58bb6d0b9394688c6ad7c679d0e05ba8d5d.js.map