  ...
  return {
    ...
    execute: function () {
      ...
      _export("ShareLayer", ShareLayer = (_dec = ccclass('ShareLayer'), _dec(_class = class ShareLayer extends (_crd && BaseLayer === void 0 ? (_reportPossibleCrUseOfBaseLayer({
        ...
        refreshTopLayer() {
          let remainNum = (_crd && designManager === void 0 ? (_reportPossibleCrUseOfdesignManager({
            error: Error()
        ...
        onClickBtnShare() {
          let uid = (_crd && localStorageManager === void 0 ? (_reportPossibleCrUseOflocalStorageManager({
            error: Error()
          ...
          (_crd && tyqSDK === void 0 ? (_reportPossibleCrUseOftyqSDK({
            ...
            let remain = (_crd && designManager === void 0 ? (_reportPossibleCrUseOfdesignManager({
              error: Error()
            }), designManager) : designManager).config.shareDayNum - (_crd && playerModel === void 0 ? (_reportPossibleCrUseOfplayerModel({
              error: Error()
            }), playerModel) : playerModel).shareObj.dayNum;
...
//# sourceMappingURL=673d3790a2bdefe433d0c09ffb57f7ccea4335e3.js.map