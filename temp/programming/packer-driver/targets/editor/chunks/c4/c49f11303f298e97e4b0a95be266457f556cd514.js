      ...
      _export("BaseUILayer", BaseUILayer = (_dec = ccclass('BaseUILayer'), _dec(_class = (_class2 = class BaseUILayer extends Component {
        ...
        addTopUILayer(layerName) {
          (_crd && resManager === void 0 ? (_reportPossibleCrUseOfresManager({
            ...
            let com = node.getComponent(layerName) || node.addComponent(layerName); // 添加到节点上后，会马上触发onLoad和onEnable回调，而start方法是在首次执行update之前被调用
        ...
        playCoinFlyAnim(count, iconpath, startPos, endPos, r = 50, iconSize = 0, delay = 0) {
          //金币分散成圆
        ...
        getCirclePoints(r, pos, count, randomScope = 50) {
          let points = [];
...
//# sourceMappingURL=c49f11303f298e97e4b0a95be266457f556cd514.js.map