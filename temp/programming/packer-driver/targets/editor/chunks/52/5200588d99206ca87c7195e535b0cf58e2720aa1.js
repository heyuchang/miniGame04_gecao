    ...
    execute: function () {
      ...
      TyqSDK = class TyqSDK {
        ...
        login() {
          ...
          let urlQuery = (_crd && tyqAdManager === void 0 ? (_reportPossibleCrUseOftyqAdManager({
            error: Error()
        ...
        */
        ...
        showBannerAd(forceShow) {
          let time = this.getSwitchValue((_crd && tyqSDKConfig === void 0 ? (_reportPossibleCrUseOftyqSDKConfig({
            error: Error()
        ...
        onShowHomeLayer() {
          ...
          let val = this.getSwitchValue((_crd && tyqSDKConfig === void 0 ? (_reportPossibleCrUseOftyqSDKConfig({
            error: Error()
        ...
        addLevelCount(level) {
          let startLevel = this.getSwitchValue((_crd && tyqSDKConfig === void 0 ? (_reportPossibleCrUseOftyqSDKConfig({
            error: Error()
          ...
          this.levelCount++;
          let val = tyqSDK.getSwitchValue((_crd && tyqSDKConfig === void 0 ? (_reportPossibleCrUseOftyqSDKConfig({
            error: Error()
...
//# sourceMappingURL=5200588d99206ca87c7195e535b0cf58e2720aa1.js.map