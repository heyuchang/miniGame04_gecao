    ...
    execute: function () {
      ...
      _export("HomeLayer", HomeLayer = (_dec = ccclass('HomeLayer'), _dec(_class = class HomeLayer extends (_crd && BaseLayer === void 0 ? (_reportPossibleCrUseOfBaseLayer({
        ...
        onLoad() {
          ...
          let urlParmas = (_crd && tyqAdManager === void 0 ? (_reportPossibleCrUseOftyqAdManager({
            error: Error()
          }), tyqAdManager) : tyqAdManager).getEnterUrlQuery();
        ...
        onClickBtnHit() {
          let bodyNode = this.getNodeByPath("monster"); // 闪白

          let shineColor = bodyNode.getComponent(_crd && ShineColor === void 0 ? (_reportPossibleCrUseOfShineColor({
            error: Error()
...
//# sourceMappingURL=de12ba6dcd0c4a29aeee3515a9d8557f94babb7a.js.map