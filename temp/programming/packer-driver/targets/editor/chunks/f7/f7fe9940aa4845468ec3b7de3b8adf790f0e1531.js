  ...
  return {
    ...
    execute: function () {
      ...
      _export("UserData", UserData = class UserData extends Component {
        ...
        getWeaponLv(id = this.$towerWeaponId) {
        ...
        checkAndUseBaoshi(num, update = false) {
          if (this.$baoShi >= num) {
        ...
        cheackAndUseCoin(num, update = false) {
          if (this.$coin >= num) {
        ...
        addExp(num) {
          this.$roleExp += num;
          let roleData = (_crd && designManager === void 0 ? (_reportPossibleCrUseOfdesignManager({
            error: Error()
        ...
        getSuitPercentAdd() {
          ...
          if (suitData != 0) {
            ...
            let suitAttr = (_crd && designManager === void 0 ? (_reportPossibleCrUseOfdesignManager({
              error: Error()
            }), designManager) : designManager).getRowById((_crd && constants === void 0 ? (_reportPossibleCrUseOfconstants({
              error: Error()
        ...
        weaponOptLvEffect(val, lv) {
          let optRow = (_crd && designManager === void 0 ? (_reportPossibleCrUseOfdesignManager({
            error: Error()
          }), designManager) : designManager).getRowById((_crd && constants === void 0 ? (_reportPossibleCrUseOfconstants({
            error: Error()
          }), constants) : constants).tableName.weaponOpt, lv);
        ...
        getTowerRoleProInfo(isEnter = false) {
          let roleData = (_crd && designManager === void 0 ? (_reportPossibleCrUseOfdesignManager({
            error: Error()
          }), designManager) : designManager).getRowById((_crd && constants === void 0 ? (_reportPossibleCrUseOfconstants({
            error: Error()
        ...
        getNextLevelExp() {
          let nextdata = (_crd && designManager === void 0 ? (_reportPossibleCrUseOfdesignManager({
            error: Error()
          }), designManager) : designManager).getRowById((_crd && constants === void 0 ? (_reportPossibleCrUseOfconstants({
            error: Error()
        ...
        checkThisPropBestToWear(propId) {
          ...
          if (propdata.wearIndex > 0) {
            if (this.$wearProp[propdata.wearIndex - 1] == 0) {
              for (let index = 0; index < this.$propData.length; index++) {
                let item = (_crd && designManager === void 0 ? (_reportPossibleCrUseOfdesignManager({
                  error: Error()
                }), designManager) : designManager).getRowById((_crd && constants === void 0 ? (_reportPossibleCrUseOfconstants({
                  error: Error()
            ...
            let wearpropdata = (_crd && designManager === void 0 ? (_reportPossibleCrUseOfdesignManager({
              error: Error()
            }), designManager) : designManager).getRowById((_crd && constants === void 0 ? (_reportPossibleCrUseOfconstants({
              error: Error()
        ...
        checkPropCanBless() {
          ...
          for (let index = 0; index < arr.length; index++) {
            if (arr[index].num >= 3) {
              let curProp = (_crd && designManager === void 0 ? (_reportPossibleCrUseOfdesignManager({
                error: Error()
              }), designManager) : designManager).getRowById((_crd && constants === void 0 ? (_reportPossibleCrUseOfconstants({
                error: Error()
        ...
        getPropSort() {
          ...
          let equipSort = (a, b) => {
            let equipDataA = (_crd && designManager === void 0 ? (_reportPossibleCrUseOfdesignManager({
              error: Error()
            }), designManager) : designManager).getRowById((_crd && constants === void 0 ? (_reportPossibleCrUseOfconstants({
              error: Error()
            }), constants) : constants).tableName.prop, a.id);
            let equipDataB = (_crd && designManager === void 0 ? (_reportPossibleCrUseOfdesignManager({
              error: Error()
            }), designManager) : designManager).getRowById((_crd && constants === void 0 ? (_reportPossibleCrUseOfconstants({
              error: Error()
        ...
        getSuitId() {
          ...
          for (let index = 0; index < this.$wearProp.length; index++) {
            ...
            if (element > 0) {
              let propData1 = (_crd && designManager === void 0 ? (_reportPossibleCrUseOfdesignManager({
                error: Error()
              }), designManager) : designManager).getRowById((_crd && constants === void 0 ? (_reportPossibleCrUseOfconstants({
                error: Error()
        ...
        getRewardProp(rewardArr, double = 1) {
        ...
        getDrawItem(drawType) {
          ...
          let isBichou = false; //  console.log("this.$drawGradeNum = ",this.$drawGradeNum)
          ...
          let drawData = (_crd && designManager === void 0 ? (_reportPossibleCrUseOfdesignManager({
            error: Error()
        ...
        getPatrolTime() {
          let curTime = new Date().getTime();
          let passTime = Math.min((_crd && designManager === void 0 ? (_reportPossibleCrUseOfdesignManager({
            error: Error()
        ...
        getPatrolReward() {
          ...
          let towerExp = Math.floor(passTime * (_crd && designManager === void 0 ? (_reportPossibleCrUseOfdesignManager({
            error: Error()
          }), designManager) : designManager).config.towerExp / 60);
          let getCoin = Math.floor(passTime * (_crd && designManager === void 0 ? (_reportPossibleCrUseOfdesignManager({
            error: Error()
          }), designManager) : designManager).config.towerCoin / 60);
          let rewardArr = []; // let prop: PropItem = {
          //     Id: 101,
          //     Num: getCoin,
          // }
          ...
          let towerItem = (_crd && designManager === void 0 ? (_reportPossibleCrUseOfdesignManager({
            error: Error()
        ...
        getPatrolRewardByTime(time) {
          let towerExp = Math.floor(time * (_crd && designManager === void 0 ? (_reportPossibleCrUseOfdesignManager({
            error: Error()
          }), designManager) : designManager).config.towerExp / 60);
          let getCoin = Math.floor(time * (_crd && designManager === void 0 ? (_reportPossibleCrUseOfdesignManager({
            error: Error()
          }), designManager) : designManager).config.towerCoin / 60);
          let rewardArr = [];
          rewardArr.push({
...
//# sourceMappingURL=f7fe9940aa4845468ec3b7de3b8adf790f0e1531.js.map