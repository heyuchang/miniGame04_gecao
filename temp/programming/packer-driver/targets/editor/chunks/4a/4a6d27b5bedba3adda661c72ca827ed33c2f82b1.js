    ...
    execute: function () {
      ...
      _export("TowerFloorLayer", TowerFloorLayer = (_dec = ccclass('TowerFloorLayer'), _dec(_class = class TowerFloorLayer extends (_crd && BaseLayer === void 0 ? (_reportPossibleCrUseOfBaseLayer({
        ...
        initUI() {
          ...
          let floor = (_crd && UserData === void 0 ? (_reportPossibleCrUseOfUserData({
            error: Error()
          ...
          let maxFloor = (_crd && designManager === void 0 ? (_reportPossibleCrUseOfdesignManager({
            error: Error()
        ...
        refreshFloorItem(itemUI, floor) {
          ...
          let mapId = this.layerData.id;
          let nowFloor = (_crd && UserData === void 0 ? (_reportPossibleCrUseOfUserData({
            error: Error()
          }), UserData) : UserData).getInstance().getTowerMapInfo(mapId).floor;
...
//# sourceMappingURL=4a6d27b5bedba3adda661c72ca827ed33c2f82b1.js.map