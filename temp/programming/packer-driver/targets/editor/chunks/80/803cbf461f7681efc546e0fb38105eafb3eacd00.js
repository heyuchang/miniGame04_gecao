  ...
  return {
    ...
    execute: function () {
      ...
      _export("WmSocket", WmSocket = (_dec = ccclass('WmSocket'), _dec(_class = (_class2 = class WmSocket {
        ...
        onMessage(resp) {
          let respJson = JSON.parse(resp); // log("onMessage resp base64解开后JSON对象:", respJson)
        ...
        send(netdata) {
          ...
          if (jsonData.length > ontTimeLimit) {
            ...
            for (let i = 0, l = str.length; i < n; i++) {
              let a = str.slice(ontTimeLimit * i, ontTimeLimit * (i + 1)); // let a = str.substr(i*ontTimeLimit,ontTimeLimit)
              // log("分段存储1111", a)
...
//# sourceMappingURL=803cbf461f7681efc546e0fb38105eafb3eacd00.js.map