      ...
      _export("PropInfoLayer", PropInfoLayer = (_dec = ccclass('PropInfoLayer'), _dec2 = property({
        ...
        onLoad() {
          ...
          if (suitId) {
            ...
            let suitData = (_crd && designManager === void 0 ? (_reportPossibleCrUseOfdesignManager({
              error: Error()
            }), designManager) : designManager).getRowById((_crd && constants === void 0 ? (_reportPossibleCrUseOfconstants({
              error: Error()
            }), constants) : constants).tableName.suit, suitId);
            this.suitNameLab.string = suitData.name;
            let suitNum = (_crd && UserData === void 0 ? (_reportPossibleCrUseOfUserData({
              error: Error()
...
//# sourceMappingURL=70d1c0ab283aabaed397f50a0d88d324ab226702.js.map