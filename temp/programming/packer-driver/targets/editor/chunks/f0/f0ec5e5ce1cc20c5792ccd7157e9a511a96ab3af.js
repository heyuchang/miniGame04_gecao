      ...
      _export("HintSystem", HintSystem = (_dec = ccclass('HintSystem'), _dec(_class = class HintSystem extends (_crd && BaseLayer === void 0 ? (_reportPossibleCrUseOfBaseLayer({
        ...
        getHintLayerByName(name) {
          ...
          if (!nameLayer) {
            ...
            let nodePoolUtil = nameLayer.addComponent(_crd && NodePoolUtil === void 0 ? (_reportPossibleCrUseOfNodePoolUtil({
              error: Error()
        ...
        addHint(name, worldPos, angle = 0, extraObj) {
          let nodePoolUtil = this.getHintLayerByName(name).getComponent(_crd && NodePoolUtil === void 0 ? (_reportPossibleCrUseOfNodePoolUtil({
            error: Error()
          }), NodePoolUtil) : NodePoolUtil);
          ...
          let tmpFunc = () => {
            ...
            let hint = (_crd && cocosUtil === void 0 ? (_reportPossibleCrUseOfcocosUtil({
              error: Error()
        ...
        recycleHintNode(hintNode) {
          let nodePoolUtil = this.getHintLayerByName(hintNode.name).getComponent(_crd && NodePoolUtil === void 0 ? (_reportPossibleCrUseOfNodePoolUtil({
            error: Error()
          }), NodePoolUtil) : NodePoolUtil);
...
//# sourceMappingURL=f0ec5e5ce1cc20c5792ccd7157e9a511a96ab3af.js.map