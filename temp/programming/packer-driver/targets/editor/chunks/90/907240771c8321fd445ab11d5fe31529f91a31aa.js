    ...
    execute: function () {
      ...
      _export("bullet8", bullet8 = (_dec = ccclass('bullet8'), _dec(_class = class bullet8 extends Component {
        ...
        updateAngleAndDis() {
          ...
          let dis = Vec2.distance(this.bullet.node.getPosition(), (_crd && mapModel === void 0 ? (_reportPossibleCrUseOfmapModel({
            error: Error()
...
//# sourceMappingURL=907240771c8321fd445ab11d5fe31529f91a31aa.js.map