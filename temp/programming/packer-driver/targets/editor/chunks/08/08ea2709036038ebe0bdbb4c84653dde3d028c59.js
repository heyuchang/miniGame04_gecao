      ...
      TyqAdManager = class TyqAdManager {
        ...
        getEnterUrlQuery() {
          if (this.channel == Channel.WECHAT) {
            ...
            if (wx.getEnterOptionsSync) {
              let options = wx.getEnterOptionsSync(); //    console.log("options", options)

              if (options && options.query) {
                //  console.log("options.query", options.query.toString())
                let openID = options.query.shareGameSync; //    console.log("login openID = ", openID)
        ...
        initAdIds() {
          if (this.channel == Channel.WECHAT) {
            ...
            let bannerIds = (_crd && tyqSDK === void 0 ? (_reportPossibleCrUseOftyqSDK({
              error: Error()
            ...
            let interstitialIds = (_crd && tyqSDK === void 0 ? (_reportPossibleCrUseOftyqSDK({
              error: Error()
            }), tyqSDK) : tyqSDK).getSwitchValue((_crd && tyqSDKConfig === void 0 ? (_reportPossibleCrUseOftyqSDKConfig({
              error: Error()
            ...
            let customRectIds = (_crd && tyqSDK === void 0 ? (_reportPossibleCrUseOftyqSDK({
              error: Error()
            }), tyqSDK) : tyqSDK).getSwitchValue((_crd && tyqSDKConfig === void 0 ? (_reportPossibleCrUseOftyqSDKConfig({
              error: Error()
            ...
            let customVIds = (_crd && tyqSDK === void 0 ? (_reportPossibleCrUseOftyqSDK({
              error: Error()
            }), tyqSDK) : tyqSDK).getSwitchValue((_crd && tyqSDKConfig === void 0 ? (_reportPossibleCrUseOftyqSDKConfig({
              error: Error()
            ...
            let customHIds = (_crd && tyqSDK === void 0 ? (_reportPossibleCrUseOftyqSDK({
              error: Error()
            }), tyqSDK) : tyqSDK).getSwitchValue((_crd && tyqSDKConfig === void 0 ? (_reportPossibleCrUseOftyqSDKConfig({
              error: Error()
            ...
            let rewardedIds = (_crd && tyqSDK === void 0 ? (_reportPossibleCrUseOftyqSDK({
              error: Error()
            }), tyqSDK) : tyqSDK).getSwitchValue((_crd && tyqSDKConfig === void 0 ? (_reportPossibleCrUseOftyqSDKConfig({
              error: Error()
        ...
        wxOnHide(res) {
          ...
          let pagePath = res.targetPagePath; // 8：跳转到小游戏内部页面WCCanvasPageViewController
          // 9：跳转到其他微信小游戏
          // 10：跳转到一个链接
        ...
        showDelayFullVideo() {
          if (this.channel == Channel.ANDROID_233) {
            let time = new Date().getTime(); // console.log("time - this._delayTime = ",time - this._delayTime)
        ...
        showCustomRectCenterAd(failcb = null) {
          if (this.channel == Channel.WECHAT) {
        ...
        */
        ...
        reportShareBehavior(operation, strategy = 1, currentShow = null) {
        ...
        showRewardedAd(successCb, failCb, forceVideo = false) {
          this.strategy = 1;
...
//# sourceMappingURL=08ea2709036038ebe0bdbb4c84653dde3d028c59.js.map