    ...
    execute: function () {
      ...
      _export("SkillSystem", SkillSystem = (_dec = ccclass('SkillSystem'), _dec(_class = class SkillSystem extends (_crd && BaseLayer === void 0 ? (_reportPossibleCrUseOfBaseLayer({
        ...
        addSkill(type, skillId = 0) {
          ...
          if (node) {
            let skillUtil = node.getComponent(_crd && Skill === void 0 ? (_reportPossibleCrUseOfSkill({
              error: Error()
          ...
          let skill = node.addComponent(_crd && Skill === void 0 ? (_reportPossibleCrUseOfSkill({
            error: Error()
          }), Skill) : Skill);
          skill.init(info);
...
//# sourceMappingURL=cfd86a2c7ac3774e8d8ce4381799bab919ae72ca.js.map